...
public class DebugExercise2 {
     ...
     * */
    public static int[] arrayMax(int[] a, int[] b) {// TODO: something wrong
        ...
        for (int i = 0; i < a.length; i += 1) {
            int biggerValue = max(a[i], b[i]);// TODO: fix max -> rewriten
    ...
    public static int arraySum(int[] x) {// TODO: fix
        int i = 0;
        int sum = 0;
        while (i < x.length) {
            sum = sum + x[i];// TODO: fix add -> delete add function
            i = i + 1;
        }
        return sum;
    }
    ...
    public static void main(String[] args) {
        ...
        int[] b = {3, -3, 2, -1};
        /**
         * request:  You should NOT step into the max or add functions or even try to understand them.
         */
